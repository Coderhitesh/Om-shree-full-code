...
const { createOrder, getAllOrder, updateOrderStatus, checkReferralCode, getMyOrderOnly, deliverMarkOrder, verifyPayment } = require('../Controllers/OrderController')
...
router.post('/become-affliate/:id',becomeAffiliate)
router.post('/verify-become-affliate/:id',verifyAlliateOtp)
